...
education_ui <- function(id) {
  ...
  bslib::layout_column_wrap(
    ...
    #     h2("Lyme Disease 101", class = "mb-2"),
    #     p(
    ...
    bslib::card(
      ...
      bslib::card_body(
        p(
          ...
          " and transmitted to humans through the bite of infected blacklegged ticks."
        ),
        tags$hr(),
        fluidRow(
          column(
    ...
    #         tags$ol(
    #           tags$li(tags$b("Tick Attachment:"), " An infected blacklegged tick bites and
    #                   attaches to human skin"),
    #           tags$li(tags$b("Feeding Period:"), " Tick must be attached for 36-48 hours
    #                   to transmit the bacteria"),
    #           tags$li(tags$b("Bacterial Transfer:"), " ", tags$em("Borrelia burgdorferi"),
    #                   " bacteria enter bloodstream"),
    #           tags$li(tags$b("Infection Spreads:"), " Bacteria disseminate through the body
    #                   if untreated")
    #         ),
    #         tags$hr(),
    #         h5("Risk Factors:"),
    ...
    #       tags$ul(
    #         tags$li(tags$b("Erythema migrans (EM) rash:"), " 'Bull's-eye' rash in 70-80%
    #                 of cases"),
