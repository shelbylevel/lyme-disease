  ...
  bslib::layout_sidebar(
    ...
    bslib::layout_column_wrap(
      ...
      bslib::card(
        ...
        bslib::card_body(
          h4(
            ...
            "How are climate and social factors increasing the population of people at risk for Lyme disease?",
      ...
      bslib::card(
        full_screen = TRUE,
        bslib::card_header(
          "What are the public health implications of a wider geographic distribution of Lyme disease?"
        ),
        # bslib::card_body(
